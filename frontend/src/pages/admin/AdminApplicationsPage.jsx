  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-2xl p-6 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-[#111827]">CSE Application Control Panel</h2>
        ...
        {apps.map((app) => (
          ...
          >
            <div className="flex items-center space-x-3">
              <div
                className={`w-11 h-11 rounded-2xl flex items-center justify-center font-bold border shrink-0 ${
                  app.isBlocked
              ...
              <div>
                <h4 className="text-base font-extrabold text-[#111827]">{app.name}</h4>
                <p className="text-xs font-semibold text-[#6B7280]">{app.category}</p>
                <div className="mt-1">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl font-extrabold text-xs shadow-2xs transition-colors cursor-pointer ${
                app.isBlocked
